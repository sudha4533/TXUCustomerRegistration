 ...
 * generated in the com.txu.webserviceclients.soap.wsdlimports package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServicePlansResponse_QNAME = new QName("http://soap.services.registrationapp.txu.com/", "getServicePlansResponse");
    private final static QName _GetServicePlans_QNAME = new QName("http://soap.services.registrationapp.txu.com/", "getServicePlans");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.txu.webserviceclients.soap.wsdlimports
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.services.registrationapp.txu.com/", name = "getServicePlansResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.services.registrationapp.txu.com/", name = "getServicePlans")
